classdef Sample < handle
    ...
    methods
        ...
        function  add_layer(self,reflectivity,refraction,thickness,rotation)
...
%                 end    
                ...
                Jt = [(1-self.sstruct{1}.R(1)).*Jtx (1-self.sstruct{1}.R(2)).*Jty];        
...
%                 end
        ...
        function Jout = backscatter(self,Jin)
            ...
            for Sindex = 1:length(self.sstruct)
                ...
                Jt = [(1-self.sstruct{Sindex}.R(1)).*Jtx (1-self.sstruct{Sindex}.R(2)).*Jty];
                Jt = (iRotA*Jt')';
            ...
            for Sindex = 1:length(self.sstruct)-1
                ...
                Jr = [(1-self.sstruct{iSindex}.R(1)).*Jrx (1-self.sstruct{iSindex}.R(2)).*Jry];
                %Jr = [Jrx Jry];
                Jr = (RotA*Jr')';
        ...
        function full_speckle_layer(self,scattering,thickness,deltan,rotation)
            ...
            for Sindex = 1:N
                self.add_layer([scattering scattering],[1.3 1.3+deltan],harray(Sindex),rotation)
            end
